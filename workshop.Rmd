...
The number of MDR isolates can be determined using the mdro() function. Use the example_isolates dataset to determine the number of MDR isolates. The default guideline CMI2012 based on the paper https://onlinelibrary.wiley.com/doi/full/10.1111/j.1469-0691.2011.03570.x. Use ?
